...
function getMaxServings(recipe, available){
    ...
    for (const ingredient in recipe) {
        ...
        let maxServingsForIngredient = available[ingredient] / recipe[ingredient];
        if(limitingFactor === null || maxServingsForIngredient < limitingFactor) {
            limitingFactor = maxServingsForIngredient;
        }
    }
    return Max.floor(limitingFactor);
}
